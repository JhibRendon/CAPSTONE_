  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="text-center">
        ...
        <div className="mt-4 p-3 bg-purple-50 rounded-lg border border-purple-200 max-w-md mx-auto">
          <p className="text-sm text-purple-800 font-medium">Office Handler Portal</p>
          <p className="text-xs text-purple-700 mt-1">Review complaints, assign cases, and manage resolution workflows</p>
        </div>
      </div>
